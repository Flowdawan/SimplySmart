...
urlpatterns = [
    ...
    path('regularGame/<int:timebased>', views.regular_game, name='regularGame'),
    path('regularGame/<int:question_id>/<str:gameMode>/<int:timebased>', views.regular_game, name='regularGame'),
    path('checkAnswer/<int:question_id>/<str:answer>', views.check_answer, name='checkAnswer'),
    path('checkAnswer/<int:question_id>/<str:answer>/<str:gameMode>/<int:timebased>', views.check_answer, name='checkAnswer'),
    path('checkAnswer/<int:question_id>/<str:gameMode>/<int:timebased>', views.check_answer, name='checkAnswer'),
